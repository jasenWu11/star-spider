...
import Alamofire
import MJRefresh
class Shop2TableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate{
    var titles:[String] = []
    var contents:[String] = []
    var images:[UIImage?] = []
    var pricem:[Double] = []
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath)
        -> UITableViewCell {
            ...
            let cell = Shop2TableViewCell.init(style: UITableViewCell.CellStyle.default, reuseIdentifier: identifier) as! Shop2TableViewCell
