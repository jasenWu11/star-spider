//
//  messagereadnTableViewController.swift
//  XZ
//
...
import Alamofire
import MJRefresh
class messagereadnTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    var titles:[String] = []
    var contents:[String] = []
    var midss:[Int] = []
    var omtimes:[String] = []
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath)
        -> UITableViewCell {
            let identifier = "MessagereadnCell"
            let cell = messagereadnTableViewCell.init(style: UITableViewCell.CellStyle.default, reuseIdentifier: identifier) as! messagereadnTableViewCell
            cell.root = self
