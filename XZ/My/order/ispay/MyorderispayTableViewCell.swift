//
//  MyorderidpayViewController.swift
//  XZ
//
...
import UIKit
import Alamofire
class MyorderispayTableViewcell: UITableViewCell {
    //视图
    ...
    var root : MyorderispayTableViewController?
    var pid:Int = 5
    var pids:Int = 5
    ...
    func setUpUI(){
        ...
        // 单价
        tv_price = UILabel(frame: CGRect(x:235, y:55, width: 100, height:20))
