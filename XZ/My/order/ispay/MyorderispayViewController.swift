//
//  MyorderispayViewController.swift
//  XZ
//
...
import Alamofire
import MJRefresh
class MyorderispayTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    var titles:[String] = []
    var pstatus:[String] = []
    var ctimes:[String] = []
    var etimes:[String] = []
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath)
        -> UITableViewCell {
            let identifier = "MyappispayCell"
            let cell = MyorderispayTableViewcell.init(style: UITableViewCell.CellStyle.default, reuseIdentifier: identifier) as! MyorderispayTableViewcell
            cell.root = self
