...
class EWPopMenuView: UIView {
    ...
    private func drawMyTableView(){
        ...
        tableView.backgroundColor = UIColor(red: 91.0/255.0, green: 84.0/255.0, blue: 145.0/255.0, alpha: 0.8)
    ...
    override func draw(_ rect: CGRect) {
        ...
        UIColor(red: 91.0/255.0, green: 84.0/255.0, blue: 145.0/255.0, alpha: 0.8).set()
